...
from opponents.player_final import Player_final
from old.bot2 import PlayerOld
from opponents.bot2 import Bot2
from opponents.team11 import Team11
from opponents.team72v3 import Team72v3
from states import *
...
class BigBoard:
	...
	def __init__(self):
		...
		self.big_boards_status = (A,B)
		self.small_boards_status = (C,D)
